...
//Lo de la puntuación por casilla (los multiplicadores que tienen) como los pongo, iniciandolos uno auno o como.
    ...
    public int puntuacionJugada()
    {
		return 0;    			//Aun por hacer.
    }
}